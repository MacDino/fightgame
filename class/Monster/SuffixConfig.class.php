...
class Monster_SuffixConfig
{
    ...
    public static function monsterSuffixList()
    {
  	...
  	public static function getMonsterSuffixConfig()
    {
        $monsterSuffixConfigList = array(
            self::MONSTER_SUFFIX_BOSS => array(
                'meet_probability' => 0.02,//遇到几率
                'attribute_change_list' => array(//基本属性变变化
                    User_Attributes::USER_ATTRIBUTE_POWER       => 10,//力量
                    User_Attributes::USER_ATTRIBUTE_MAGIC_POWER => 10,//魔力
                    User_Attributes::USER_ATTRIBUTE_PHYSIQUE    => 20,//体质
                    User_Attributes::USER_ATTRIBUTE_ENDURANCE   => 10,//耐力
                    User_Attributes::USER_ATTRIBUTE_QUICK       => 10,//敏捷
                ),
              ...
              self::MONSTER_SUFFIX_SACRED => array(
                'meet_probability' => 0.05,//遇到几率
                'attribute_change_list' => array(//基本属性变变化
                    User_Attributes::USER_ATTRIBUTE_POWER       => 5,//力量
            ...
            self::MONSTER_SUFFIX_UNKNOWN => array(
                'meet_probability' => 0.05,//遇到几率
                'attribute_change_list' => array(//基本属性变变化
                    ...
                    User_Attributes::USER_ATTRIBUTE_PHYSIQUE    => 1,//体质
                    User_Attributes::USER_ATTRIBUTE_ENDURANCE   => 1,//耐力
                    User_Attributes::USER_ATTRIBUTE_QUICK       => 5,//敏捷
                ),
                'experience_change' => 2, //经验加成
                'money_change' => 2, //金币加成
                'equip_get_probability' => array(
            ...
            self::MONSTER_SUFFIX_ADVANCED => array(
                'meet_probability' => 0.05,//遇到几率
                'attribute_change_list' => array(//基本属性变变化
                    User_Attributes::USER_ATTRIBUTE_POWER       => 1,//力量
                    User_Attributes::USER_ATTRIBUTE_MAGIC_POWER => 1,//魔力
                    User_Attributes::USER_ATTRIBUTE_PHYSIQUE    => 5,//体质
                    User_Attributes::USER_ATTRIBUTE_ENDURANCE   => 1,//耐力
                    User_Attributes::USER_ATTRIBUTE_QUICK       => 1,//敏捷
                ),
                'experience_change' => 2, //经验加成
            ...
            self::MONSTER_SUFFIX_WILL_EXTINCT => array(
                'meet_probability' => 0.05,//遇到几率
                'attribute_change_list' => array(//基本属性变变化
                    User_Attributes::USER_ATTRIBUTE_POWER       => 1,//力量
                    User_Attributes::USER_ATTRIBUTE_MAGIC_POWER => 5,//魔力
                    User_Attributes::USER_ATTRIBUTE_PHYSIQUE    => 1,//体质
                    User_Attributes::USER_ATTRIBUTE_ENDURANCE   => 1,//耐力
                    User_Attributes::USER_ATTRIBUTE_QUICK       => 1,//敏捷
                ),
            ...
            self::MONSTER_SUFFIX_CURSED => array(
                'meet_probability' => 0.05,//遇到几率
                'attribute_change_list' => array(//基本属性变变化
                    User_Attributes::USER_ATTRIBUTE_POWER       => 1,//力量
                    User_Attributes::USER_ATTRIBUTE_MAGIC_POWER => 1,//魔力
                    User_Attributes::USER_ATTRIBUTE_PHYSIQUE    => 1,//体质
                    User_Attributes::USER_ATTRIBUTE_ENDURANCE   => 5,//耐力
                    User_Attributes::USER_ATTRIBUTE_QUICK       => 1,//敏捷
                ),
                'experience_change' => 2, //经验加成
                'money_change' => 2, //金币加成
            ...
            self::MONSTER_SUFFIX_ANCIENT => array(
                'meet_probability' => 0.05,//遇到几率
                'attribute_change_list' => array(//基本属性变变化
                    User_Attributes::USER_ATTRIBUTE_POWER       => 1.25,//力量
                    User_Attributes::USER_ATTRIBUTE_MAGIC_POWER => 1.25,//魔力
                    User_Attributes::USER_ATTRIBUTE_PHYSIQUE    => 1.25,//体质
                    User_Attributes::USER_ATTRIBUTE_ENDURANCE   => 1.25,//耐力
                    User_Attributes::USER_ATTRIBUTE_QUICK       => 1.25,//敏捷
                ),
                'experience_change' => 2, //经验加成
                'money_change' => 2, //金币加成
                'equip_get_probability' => array(
            ...
            self::MONSTER_SUFFIX_HEAD => array(
                'meet_probability' => 0.1,//遇到几率
                'attribute_change_list' => array(//基本属性变变化
                    User_Attributes::USER_ATTRIBUTE_POWER       => 1.05,//力量
                    User_Attributes::USER_ATTRIBUTE_MAGIC_POWER => 1.05,//魔力
                    User_Attributes::USER_ATTRIBUTE_PHYSIQUE    => 1.05,//体质
                    User_Attributes::USER_ATTRIBUTE_ENDURANCE   => 1.05,//耐力
                    User_Attributes::USER_ATTRIBUTE_QUICK       => 1,//敏捷
                ),
