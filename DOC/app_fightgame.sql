...
--
-- Table structure for table `equid_attributes`
--
...
--
-- Dumping data for table `map_monster`
--

LOCK TABLES `map_monster` WRITE;
/*!40000 ALTER TABLE `map_monster` DISABLE KEYS */;
/*!40000 ALTER TABLE `map_monster` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `user_equip` VALUES (17,27,4,1,0,0,0,'{\"114\":1,\"208\":1,\"210\":1}','null'),(18,27,4,2,0,0,0,'{\"106\":0.05,\"109\":0.03,\"202\":1}','null'),(19,27,4,3,0,0,0,'{\"103\":0.02,\"104\":0.03,\"202\":1}','null'),(20,27,4,4,0,0,0,'{\"113\":0.04,\"208\":1,\"209\":1}','null'),(21,27,4,5,0,0,0,'{\"301\":0.01,\"204\":1,\"210\":1}','null'),(22,27,4,6,0,0,0,'{\"113\":0.03,\"202\":1,\"203\":1}','null');
