...
CREATE TABLE `props`(
	  ...
	  `static_code` int(6) DEFAULT NULL,
	  `props_name` varchar(100) NOT NULL,
	  `props_desc` varchar(300) NOT NULL COMMENT '描述',
	  `price_type` tinyint(3) NOT NULL DEFAULT '1' COMMENT '价格类型  1：固定价格  2：动态价格',
	  `price` int(11) NOT NULL COMMENT '花费的元宝数',
	  PRIMARY KEY (`props_id`)
	...
	INSERT INTO `props` (`props_id`, `props_cate_id`, `static_code`, `props_name`, `props_desc`, `price_type`, `price`) VALUES
	(1, 1, 6301, '双倍咒符', '铜钱经验翻倍', 1, 20),
	(2, 1, 6302, 'PK咒符', '增加PK次数', 1, 10),
	(3, 1, 6303, '属性增强咒符', '增强使用者成长属性的5%，不能叠加使用。有效时间24小时。', 1, 20),
	(4, 1, 6304, '人宠增强咒符', '增加可携带的人宠空间', 1, 10),
	(5, 1, 6305, '背包咒符', '增加可携带的装备空间。', 1, 10),
	(6, 1, 6306, '挂机咒符', '挂机咒符'',''使用后可以挂机2个小时，按分钟计时。', 1, 50),
	(7, 1, 6307, '好友上限咒符', '增加好友上限。', 1, 100),
	(8, 2, 6308, '锻造成功咒符', '增加10%成功几率。', 1, 100),
	(9, 2, 6309, '装备成长咒符', '1.装备等级+10   2.保持附加属性不变，基本属性根据之前装备基本属性所在范围（一般、高、很高）重新随机。 3.保持锻造段数不变。 4.   30级的装备可以使用成长符。', 2, 0),
	(10, 3, 6310, '30级普通宝箱', '可以随机获得一件30级蓝色以上装备，其中橙色40%几率。', 1, 300),
	(11, 3, 6311, '30级精品宝箱', '可以随机获得十件30级蓝色以上装备，其中其中至少4件橙色装备，套装2件。', 1, 2400),
	(12, 3, 6312, '40级普通宝箱', '可以随机获得一件40级蓝色以上装备，其中橙色40%几率。', 1, 400),
	(13, 3, 6313, '40级精品宝箱', '可以随机获得十件40级蓝色以上装备，其中其中至少4件橙色装备，套装2件。', 1, 3200),
	(14, 3, 6314, '50级普通宝箱', '可以随机获得一件50级蓝色以上装备，其中橙色40%几率。', 1, 500),
	(15, 3, 6315, '50级精品宝箱', '可以随机获得十件50级蓝色以上装备，其中其中至少4件橙色装备，套装2件。', 1, 4000),
	(16, 3, 6316, '60级普通宝箱', '可以随机获得一件60级蓝色以上装备，其中橙色40%几率。', 1, 600),
	(17, 3, 6317, '60级精品宝箱', '可以随机获得十件60级蓝色以上装备，其中其中至少4件橙色装备，套装2件。', 1, 4800),
	(18, 3, 6318, '70级普通宝箱', '可以随机获得一件70级蓝色以上装备，其中橙色40%几率。', 1, 700),
	(19, 3, 6319, '70级精品宝箱', '可以随机获得十件70级蓝色以上装备，其中其中至少4件橙色装备，套装2件。', 1, 5600),
	(20, 3, 6320, '80级普通宝箱', '可以随机获得一件80级蓝色以上装备，其中橙色40%几率。', 1, 800),
	(21, 3, 6321, '80级精品宝箱', '可以随机获得十件80级蓝色以上装备，其中其中至少4件橙色装备，套装2件。', 1, 6400),
	(22, 3, 6322, '90级普通宝箱', '可以随机获得一件90级蓝色以上装备，其中橙色40%几率。', 1, 900),
